...
func nextPhrase() -> void:
	...
	if phraseNum >= len(dialog):
		queue_free()
		var a = get_tree().change_scene("res://scenes/savingFinal.tscn")
		return a
	...
	var f=File.new()
	var img = "res://resources/dialogs/substring_post2/" + dialog[phraseNum]["Name"] + dialog[phraseNum]["Emotion"] + ".png"
