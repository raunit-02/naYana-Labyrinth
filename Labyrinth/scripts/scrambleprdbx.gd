...
func nextPhrase() -> void:
	...
	if phraseNum >= len(dialog):
		queue_free()
		var a = get_tree().change_scene("res://scenes/scramble_rules.tscn")
		return a
	...
	var f=File.new()
	var img = "res://resources/dialogs/scramble_pre/" + dialog[phraseNum]["Name"] + dialog[phraseNum]["Emotion"] + ".png"
