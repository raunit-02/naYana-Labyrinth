...
func nextPhrase() -> void:
	...
	if phraseNum >= len(dialog):
		queue_free()
		var a = get_tree().change_scene("res://scenes/labyrinthinrto.tscn")
		return a
	...
	var f=File.new()
	var img = "res://resources/dialogs/labyrinth_intro/" + dialog[phraseNum]["Name"] + dialog[phraseNum]["Emotion"] + ".png"
